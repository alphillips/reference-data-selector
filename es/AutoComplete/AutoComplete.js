...
var AutoComplete = (_temp2 = _class = function (_Component) {
  ...
  function AutoComplete() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
      ...
      _this.setState({ isMouseOverMenu: true });
    }, _this.handleMouseLeave = function () {
      _this.setState({ isMouseOverMenu: false });
      ...
      switch (keycode(event)) {
        ...
        case 'down':
          ...
          _this.setState({
            ...
            anchorEl: ReactDOM.findDOMNode(_this.refs.searchTextField)
          });
          break;
      ...
      if (_this.state.focusTextField && !_this.state.isMouseOverMenu && _this.timerTouchTapCloseId === null) {
      ...
      clearTimeout(_this.timerBlurClose);
  ...
  AutoComplete.prototype.render = function render() {
    ...
    var displayText = this.state.searchText;
    ...
    var menu = open && requestsList.length > 0 && React.createElement(
      'div',
      {
